...
export default defineCommand(
    {
        ...
        async Handle(interaction) {
            ...
            const webhook_type = interaction.data.options.getString("webhook-type") as schemas.Webhook_Type;
            ...
            menu.minValues = 1;
            let trigger: schemas.Webhook_Trigger[];
            ...
            async function handleInteraction(int: oceanic.ClientEvents["interactionCreate"][0]) {
                if (int.type == oceanic.InteractionTypes.MESSAGE_COMPONENT) {
                    if (int.data.customID == menu_id) {
                        ...
                        trigger = interact.data.values.getStrings() as schemas.Webhook_Trigger[];
                        submit.disable();
                        menu.disable();
