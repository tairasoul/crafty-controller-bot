...
import { ApplicationCommandOptionTypes, ApplicationCommandOptionsChoice } from "oceanic.js";
...
export default defineCommand(
    {
        ...
        options: [
            ...
            },
            {
                ...
                choices: (() => {
                    ...
                    const ret: ApplicationCommandOptionsChoice<ApplicationCommandOptionTypes.STRING>[] = [];
        ...
        async Handle(interaction) {
            ...
            const action = interaction.data.options.getString("action", true) as "start" | "stop" | "restart" | "kill" | "backup" | "update";
